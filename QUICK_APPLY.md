# ⚡ QUICKEST WAY TO ADD RAZORPAY - 3 MINUTES!

## 🎯 OPTION 1: Run Python Script (EASIEST!)

```bash
# Download the script
wget https://raw.githubusercontent.com/rahulprasadjai-a11y/rahulmobile-site/main/apply_razorpay.py

# Run it
python3 apply_razorpay.py
...
- ✅ Adds Razorpay scripts
- ✅ Updates checkout button
- ✅ Adds success modal
- ✅ Adds all JavaScript functions

---

## 🎯 OPTION 2: Manual Copy-Paste (5 MINUTES)

### **STEP 1: Add to `<head>` (Line 8)**
...
### **STEP 2: Replace Checkout Button (Line ~1360)**
...
### **STEP 3: Add Success Modal (After UPI Modal ~Line 1410)**

Find the end of UPI modal (look for `</div>` after UPI payment section).
...
### **STEP 4: Add JavaScript (Before `</script>` ~Line 2010)**

Find this code near the end:
```javascript
...
Add this COMPLETE code RIGHT AFTER it (before `</script>`):
```javascript
...
## 🎯 OPTION 3: Use GitHub Web Editor

1. Go to: https://github.com/rahulprasadjai-a11y/rahulmobile-site/edit/main/index.html
2. Press `Ctrl+F` to find each section
3. Copy-paste from STEP 1-4 above
...
**Files to reference:**
- `apply_razorpay.py` - Automated script
- `UPDATE_INSTRUCTIONS.md` - Detailed guide
- `RAZORPAY_SETUP.md` - Complete setup info
- `RAZORPAY_PATCH.html` - All code snippets
